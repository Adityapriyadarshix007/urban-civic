import { Clock, MapPin, CheckCircle, AlertCircle, Loader, Trash2, Droplet, LampFloor } from 'lucide-react';
        ...
        <div className="flex flex-col flex-1">
          ...
          {viewMode === 'full' && (
            <CardFooter className="p-4 pt-0 flex items-center justify-between">
              <div className="text-xs text-muted-foreground">
                Updated: {format(new Date(report.updatedAt || report.timestamp), 'MMM d, yyyy')}
              </div>
              {report.assignedTo && (
