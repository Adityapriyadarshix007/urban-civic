...
import { ArrowRight, CheckCircle, MapPin, Camera, Users } from 'lucide-react';
...
import robotAnimation from '../assets/robot-construction.json'; // Make sure this exists
        ...
        <section className="py-16 md:py-24 px-6">
          <div className="container mx-auto">
            <div className="relative overflow-hidden rounded-3xl bg-muted/30 p-8 md:p-12">
              <div className="absolute top-0 right-0 -mt-4 -mr-4 h-32 w-32 rotate-12 opacity-10">
              ...
              <div className="max-w-3xl">
                ...
                <p className="mt-4 text-lg text-muted-foreground">
                  Be part of the solution. Join thousands of active citizens who are making their neighborhoods better places to live.
                </p>
